In the following 3 modules

- spring-boot-2.7.6 (`spring-boot-lib` as **compile** scope dependency and `spring-boot-test` as **test** dependency)
- spring-boot-lib (`spring-boot-starter-oauth2-client` as **compile** scope dependency)
- spring-boot-test (`spring-security-oauth2-client` as **compile** dependency)

We see that spring-boot-2.7.6 has the following dependency tree
...
[INFO] +- com.example:spring-boot-lib:jar:0.0.1-SNAPSHOT:compile
...
[INFO] |     \- org.springframework.security:spring-security-oauth2-jose:jar:5.7.5:compile
[INFO] |        \- com.nimbusds:nimbus-jose-jwt:jar:9.22:compile
[INFO] \- com.example:spring-boot-test:jar:0.0.1-SNAPSHOT:test
...
[INFO]       +- org.springframework.security:spring-security-oauth2-core:jar:5.7.5:compile
